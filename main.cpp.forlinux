...
void writeText(string file,string s){
    ...
    sprintf(tmp, "%04d-%02d-%02d %02d:%02d:%02d",1900+stime->tm_year,1+stime->tm_mon,
            stime->tm_hour+8>=24?stime->tm_mday+1:stime->tm_mday, stime->tm_hour+8>=24?stime->tm_hour-=16:stime->tm_hour+8,
...
void judgment1(){
    if(fivep+fourp+threep!=1||increasep>1||increaset<0||fourpt<0||jsfi>1||jsfo>1||jsth>1){
